...
var _m = _interopRequireDefault(__webpack_require__(/*! ./modules/m2.js */ 18));
var _http = _interopRequireDefault(__webpack_require__(/*! @/common/http */ 19));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}

_vue.default.use(_vuex.default);
//this指向store
var store = new _vuex.default.Store({
  modules: {
    userModule: _user.default,
    module2: _m.default },
  ...
  mutations: {
    ...
    commitCity: function commitCity(state, params) {
      state.cities = params;
    },
    commitBussTypes: function commitBussTypes(state, params) {
      state.bussinessTypes = params;
    },
    commitLyLevels: function commitLyLevels(state, params) {
    ...
    commitWebsocketConnect: function commitWebsocketConnect(state, params) {
      state.websocketConnect = params;
    },
    commitSocketInfo: function commitSocketInfo(state, params) {
      var c = state.socketInfo;
  ...
  actions: { //Action 类似于 mutation，不同在于：Action 提交的是 mutation，而不是直接变更状态。Action 可以包含任意异步操作。
    ...
    getProvinceCity: function getProvinceCity(context, param) {
      var res = _http.default.ajax({
    ...
    getBussinessTypes: function getBussinessTypes(context) {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var res;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                ...
                if (res && res.data) {
                  _this.bussinessTypes = res.data;
                  context.commit('commitBussTypes', res.data);
                }case 4:case "end":return _context.stop();}}}, _callee);}))();

    },
    getLawyerLevels: function getLawyerLevels(context) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var res;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (
                  _http.default.ajax({
                    url: 'layer/level',
                    methods: 'GET',
    ...
    getWorkAges: function getWorkAges(context) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {var res;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:_context3.next = 2;return (
                  _http.default.ajax({
                    url: 'layer/LayerAge',
                    methods: 'GET',
      ...
      return new Promise(function (resolve, feject) {
        ...
        uni.login({
          ...
          success: function () {var _success = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4(res) {var code, res1;return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
                      ...
                      if (!res.code) {_context4.next = 21;break;}
                      code = res.code;_context4.next = 6;return (
                        _http.default.ajax({
                          url: 'wechat/login',
                          data: {
                            // pid: context.state.pid,
                            pid: uni.getStorageSync('scene'),
                            code: code } }));case 6:res1 = _context4.sent;


                      console.log('===========getwxcode=======================');
                      console.log(res1);if (!(

                      res1.code == -1)) {_context4.next = 13;break;}
                      uni.showToast({
                        title: res1.message,
                        icon: 'none' });

                      reject(res1);return _context4.abrupt("return");case 13:if (!(


                      res1 && res1.code == 200)) {_context4.next = 19;break;}
                      console.log('');
                      context.commit('commitUserInfo', res1.data);
                      uni.setStorageSync('userInfo', res1.data);
                      resolve({ hasUserInfo: true });return _context4.abrupt("return");case 19:_context4.next = 23;break;case 21:
                      ...
                      resolve({ hasUserInfo: false });case 23:case "end":return _context4.stop();}}}, _callee4);}));function success(_x) {return _success.apply(this, arguments);}return success;}() });
                        ...
                        uni.getUserProfile({
                          ...
                          success: function () {var _success2 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee5(res) {var _res$userInfo, avatarUrl, city, country, gender, language, nickName, province, data, res1;return _regenerator.default.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:
                                      ...
                                      data = {
                                        ...
                                        province: province,
                                        city: city,
                                        user_id: userInfo && userInfo.user_id };_context5.next = 8;return (


                                        _http.default.ajax({
                                          url: 'wechat/setUserinfo',
                                          method: 'GET',
                                          data: data }));case 8:res1 = _context5.sent;
                                      ...
                                      if (res1.code == 200) {
                                        ...
                                        reject(false);
                                      }case 10:case "end":return _context5.stop();}}}, _callee5);}));function success(_x4) {return _success2.apply(this, arguments);}return success;}(),
...
var _index = _interopRequireDefault(__webpack_require__(/*! ../index.js */ 12));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
/**
...
module1;exports.default = _default;
...
var module2 = {
  ...
  mutations: {
    updateNameByMutation: function updateNameByMutation(state, appendStr) {
      state.name = state.name + " append Str: " + appendStr;
    } },

  actions: {
    udpateNameByAction: function udpateNameByAction(_ref, appendStr) {var commit = _ref.commit;
      commit("updateNameByMutation", appendStr);
    } },

  getters: {
    getNameA: function getNameA(state) {
      return state.name;
    },
    getModule2: function getModule2(state) {
      return "module2";
    } } };var _default =


module2;exports.default = _default;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var baseUrl = 'https://layer.boyaokj.cn/api/';
...
/***/ 21:
/*!***********************************************!*\
  !*** G:/mofei/item/lawyer123/common/share.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
