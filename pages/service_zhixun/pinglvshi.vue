<template>
	<view class="flex-column mx-start sx-stretch" style="padding: 20rpx;font-size: 32rpx;">
		<view class="flex-column mx-center sx-stretch" style="margin-bottom: 20rpx;flex: 0 0 80rpx;padding: 20rpx;background-color: #F4F4F4;border-radius: 20rpx;">
			<input class="uni-input"   v-model="title" placeholder="请输案件标题,如婚姻家庭或交通事故" style="flex:1 1 auto;background-color: #FFFFFF;padding-left: 20rpx;" >
		</view>
		...
		<view class="flex-row mx-center sx-center" style="background-color: #F4F4F4;height: 60rpx;padding: 10rpx 0;"  @tap="searchKeyWord">
		...
		<view class="flex-row mx-center sx-center">
			<view class="flex-txt-center" @tap="commit" style="flex: 1 1 auto;margin: 20rpx;height: 80rpx;border-radius:30rpx;background-color: #57A9FF;color: #FFFFFF;">
				提交
			</view>
		</view>
