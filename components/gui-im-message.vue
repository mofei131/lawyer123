	...
	:style="{'background-color':background}">
		<block v-for="(item, index) in msgs" :key="index">
			<block v-if="item.group == group">
				<!-- 系统消息 -->
				<view class="gui-im-msg flex-row mx-center sx-center" 
				v-if="item.contentType == 'system'">
					<view class="gui-im-system-msg " style="background-color: black;">{{item.msg}}</view>
				</view>
				<!-- 用户消息 -->
				<view v-else>
					...
					:class="[userid == item.uindex ? 'gui-im-msg-right' : 'gui-im-msg-left']">
						...
						<view class="gui-im-content-in">
							...
							:class="[userid == item.uindex ? 'gui-im-flex-end' : '']">
								<view 
								class="flex-row mx-center sx-center" 
								:class="[
								'gui-im-voice-msg', 
							...
							<view :class="[userid == item.uindex ? 'flex-txt-right-center' : '']">
